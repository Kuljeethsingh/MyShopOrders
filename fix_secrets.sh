...
REGION="asia-south2"
URL="https://sweetshop-app-651619400820.asia-south2.run.app"
...
# Private Key - using single quotes to preserve newlines and special chars
...
echo "Updating Cloud Run secrets for $SERVICE_NAME..."
